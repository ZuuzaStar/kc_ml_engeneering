        ...
        if total_added_count > 0:
            ...
            try:
                ...
                with engine.connect() as connection:
                    connection.execute(text("CREATE INDEX IF NOT EXISTS idx_movie_embedding_ivfflat ON movie USING ivfflat (embedding vector_cosine_ops) WITH (lists = 100)"))
                    connection.commit()
